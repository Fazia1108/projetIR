...
public class Fanfaron implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "id_contrainte_alimentaire", nullable = false)
    ...
    private String role; // Soit ADMIN, soit USER
    ...
    public Fanfaron(String nomFanfaron, String email, String motDePasse, String prenom, String nom,
                    Genre genre, ContrainteAlimentaire contraintesAlimentaires) {
    ...
    public void setContraintesAlimentaires(ContrainteAlimentaire contraintesAlimentaires) {
        this.contraintesAlimentaires = contraintesAlimentaires;
    }
